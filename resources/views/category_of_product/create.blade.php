            ...
            <div class="contact-form">
                ...
                <form action="{{ route('category_of_product.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="title_uz" placeholder="mahsulot nomi uz" value="{{ old('title_uz') }}" />
                        @error('title_uz')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="title_ru" placeholder="Mahsulot nomi ru" value="{{ old('title_ru') }}" />
                        @error('title_ru')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="title_en" placeholder="mahsulot nomi en" value="{{ old('title_en') }}" />
                        @error('title_en')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="short_content_uz" placeholder="Mahsulot haqida qisqacha uz" value="{{ old('short_content_uz') }}" />
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="short_content_ru" placeholder="mahsulot haqida qisqacha ru" value="{{ old('short_content_ru') }}" />
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="short_content_en" placeholder="mahsulot haqida qisqacha en" value="{{ old('short_content_en') }}" />
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="name_uz" placeholder="mahsulot nomi uz" value="{{ old('name_uz') }}" />
                        @error('name_uz')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="name_ru" placeholder="mahsulot nomi ru" value="{{ old('name_ru') }}" />
                        @error('name_ru')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="name_en" placeholder="nahsulot nomi en" value="{{ old('name_en') }}" />
                        @error('name_en')
