...
<x-layouts.main>
                ...
                <div class="col-sm-12">
                    <div class="slide_img beforelsiee xlnone d-xl-none">
                        @foreach($homes as $home)
                            <img src="{{ asset('storage/' . $home->photo) }}" class="img-1" alt="slide_shape_01">
                        @endforeach
                        <img src="./assets/img/slide/p1.png" class="img-2 position-absolute" alt="slide_shape_02">
                        <img src="./assets/img/slide/p2.png" class="img-3 position-absolute" alt="slide_shape_03">
                        <img src="./assets/img/slide/p3.png" class="img-4 position-absolute" alt="slide_shape_04">
                        <img src="./assets/img/slide/p4.png" class="img-5 position-absolute" alt="slide_image">
                    </div>
                </div>
                @foreach($homes as $home)
                    <div class="col-md-12 col-lg-8 col-xl-6">
                        <div class="slide_content">
                            <h4 class="animated wow animate__fadeIn" data-animation="fadeInUp" data-delay="2s"
                                data-wow-duration="2s">Photo
                                <span>Editing Company</span>
                            </h4>
                            <h2 class="wow animate__fadeIn" data-animation="fadeInUp" data-delay="2.5s"
                                data-wow-duration="2.5s">{{ $home['title_' . $lang] }}</h2>
                            <p class="wow animate__fadeIn" data-animation="fadeInUp" data-delay="3s"
                               data-wow-duration="3s">
                                {{ $home['short_content_' . $lang] }}</p>
                            <div class="site_button site_button-two">
                                <a class="cmn_btn slide_btn slide_btn_01 " href="login.html">Free Trail <i
                                        class="fas fa-chevron-right"></i></a>
                                <a class="cmn_btn cmn_outline " href="customQuote.html"><span>Make A Budget</span><i
                        ...
                        <div class="wrap_about">
                            ...
                            <div class="about_content">
                                ...
                                <div class="site_button">
                                    <a class="cmn_btn cmn_outline " href="/about"><span>Read more</span> <i
                                            class="fas fa-chevron-right"></i></a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="service_area custom_animation mb-120 mobile-res-mb">
        <div class="service_shapes">
            <img src="./assets/img/shapes/service_right.png" class="position-absolute service_01"
                 alt="service_shapes">
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="service_activition">
                        <div class="service_card">
                            <div class="service_img text-center">
                                <img src="./assets/img/service/service_one.png" alt="service_img">
                            </div>
                            <div class="service_content text-center">
                                <h3 class="service_title">Image Masking</h3>
                                <p class="light_color">There are many variations of passages</p>
                                <p>Starting at <b> $1.19</b> per image</p>
                            </div>
                            <a class="radius_btn effectPlus" href="service-details.html">
                                <i class="icon-serviceicon"></i>
                            </a>
                        </div>
                        <div class="service_card">
                            <div class="service_img service_img_two text-center service_two">
                                <img src="./assets/img/service/service_two.png" alt="service_img">
                            </div>
                            <div class="service_content service_content_two text-center">
                        ...
                        <div class="service_card">
                            <div class="service_img service_img_three text-center service_three">
                                <img src="./assets/img/service/service_three.png" alt="service_img">
                            </div>
                            <div class="service_content text-center">
                        ...
                        <div class="service_card">
                            <div class="service_img service_img_four text-center">
                                <img src="./assets/img/service/service_four.png" alt="service_img">
                            </div>
                            <div class="service_content text-center">
            ...
            <div class="row align-items-center">
                <div class="col-md-12 col-xl-8 text-center">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="process_card wow animate__fadeIn" data-animation="fadeInUp"
                                 data-delay="1.5s" data-wow-duration="1.2s">
                                <div class="process_icon process_icon_2">
                                    <img class="process_two" src="./assets/img/services/ss_two.png"
                                         alt="process_icon">
                                </div>
                                <div class="process_content">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="process_card wow animate__fadeIn" data-animation="fadeInUp" data-delay="2s"
                                 data-wow-duration="1.5s">
                                <div class="process_icon process_icon_3">
                                    <img class="process_three" src="./assets/img/services/ss_three.png"
                                         alt="process_icon">
                                </div>
                                <div class="process_content">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="process_card wow animate__fadeIn" data-animation="fadeInUp"
                                 data-delay="2.5s" data-wow-duration="1.8s">
                                <div class="process_icon process_icon_4">
                                    <img class="process_four" src="./assets/img/services/ss_four.png"
                                         alt="process_icon">
                                </div>
                                <div class="process_content">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="process_card wow animate__fadeIn" data-animation="fadeInUp" data-delay="3s"
                                 data-wow-duration="2s">
                                <div class="process_icon process_icon_5">
                                    <img class="process_five" src="./assets/img/services/ss_five.png"
                                         alt="process_icon">
                                </div>
                                <div class="process_content">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="process_card mb-0 wow animate__fadeIn" data-animation="fadeInUp"
                                 data-delay="3.5s">
                                <div class="process_icon process_icon_6">
                                    <img class="process_six" src="./assets/img/services/ss_six.png"
                                         alt="process_icon">
                                </div>
                                <div class="process_content">
                ...
                <div class="col-md-4 d-none d-xl-block">
                    <div class="process_image">
                        <div class="process_shape">
                            <img class="process_shape_02" src="./assets/img/services/shape_ss_02.png"
                                 alt="process_shape_02">
                            <img class="process_shape_04" src="./assets/img/services/shape_ss_04.png"
                                 alt="process_shape_04">
                            <img class="process_shape_05" src="./assets/img/services/shape_ss_05.png"
                                 alt="process_shape_05">
                            <img class="process_shape_06" src="./assets/img/services/shape_ss_06.png"
                                 alt="process_shape_06">
                            <img class="process_shape_07" src="./assets/img/services/shape_ss_07.png"
                                 alt="process_shape_08">
                            <!-- <img class="process_shape_09" src="./assets/img/services/rocket.png" alt="process_shape_06"> -->
                            <img class="process_shape_10" src="./assets/img/services/rocketwithpeople.png"
                                 alt="process_shape_06">
                        </div>
                    </div>
                </div>
            ...
            <div class="row custom-center">
                        ...
                        <div class="wrapper wrapper_two">
                            <div class="video-main">
                                ...
                                @foreach($links as $link)
                                    <a href="{{ $link->link }}"
                                       class="videoTwo video-popup mfp-iframe popupImage" data-lity><i
                ...
                <div class="col-xl-4">
                    @foreach($actives as $active)
                        <div class="shoot_card before_shoot_01 wow animate__fadeIn" data-animation="fadeInUp"
                             data-delay="2.5s" data-wow-duration="1s">
                        ...
                        <div class="shoot_card before_shoot_02 wow animate__fadeIn" data-animation="fadeInUp"
                             data-delay="2.5s" data-wow-duration="2s">
                            <div class="shoot_icon">
                        ...
                        <div class="shoot_card before_shoot_03 wow animate__fadeIn" data-animation="fadeInUp"
                ...
                <div class="col-md-12">
                    <div class="section_wrapper text-center mb-10">
                        <h4 class="sub_title wow animate__fadeIn" data-animation="fadeInUp" data-delay="2s"
                            data-wow-duration="3s">Clients Feedback</h4>
                        <h2 class="title wow animate__fadeIn" data-animation="fadeInUp" data-delay="2s"
                            data-wow-duration="2.5s">explore clients review</h2>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section_wrapper section_wrapper_mobile text-center mb-60">
                        <h4 class="sub_title wow animate__fadeIn" data-animation="fadeInUp" data-delay="2s"
                            data-wow-duration="3s">Our products</h4>
                        <h2 class="title wow animate__fadeIn" data-animation="fadeInUp" data-delay="2.5s"
                            data-wow-duration="3s">Popular products</h2>
                    </div>
                </div>
            </div>
            <div class="row align-items-center">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section_wrapper text-center mb-40">
                        <h4 class="sub_title wow animate__fadeIn" data-animation="fadeInUp" data-delay="2s"
                            data-wow-duration="3s">clients</h4>
                        <h2 class="title wow animate__fadeIn" data-animation="fadeInUp" data-delay="2.5s"
                            data-wow-duration="3s">some of our clients</h2>
                    </div>
                </div>
            </div>
            <div class="row">
    ...
    <div class="news_area mobile-res-mb">
        ...
        <div class="container">
            <div class="row">
                @foreach($blog_text as $text)
                    <div class="col-md-12 col-lg-5">
                        <div class="section_wrapper news-wrapper">
                            <h4 class="sub_title wow animate__fadeIn" data-animation="fadeInUp" data-delay="2s"
                                data-wow-duration="2s">{{ $text['title_' . $lang] }}</h4>
                            <h2 class="title wow animate__fadeIn" data-animation="fadeInUp" data-delay="2.5s"
                                data-wow-duration="2s">{{ $text['short_content_' . $lang] }}</h2>
                ...
                @endforeach
                <div class="col-md-12 col-lg-7">
                    <div class="row blog_activition_home_one">
                ...
                <div class="col-md-12">
                    <div class="subscribe_card">
                        <form action="#" method="post">
                            ...
                            <button type="submit" class="subcribe_btn">yuborish<i
                        ...
                        <div class="social_contact">
                            <a href="mailto:name@email.com"><svg width="20.87" height="15">
                                    <g id="Mail_2" data-name="Mail 2" transform="translate(-163.667 -153.91)">
                                        <path id="dfdf" data-name="Path 22"
                                              ...
                                              fill="#438ff9" />
                                        <path id="dfdeyyf" data-name="Path 23"
                                        ...
                                        <path id="sdfs" data-name="Path 24"
                            ...
                            <a href="tel:+4733378901"><svg width="17.224" height="17.224"
                                                           viewBox="0 0 17.224 17.224">
                                    <g id="dfde" transform="translate(-255.083 -150.41)">
                                        <path id="dfd" data-name="Path 26"
                                        ...
                                        <path id="dfdplgw" data-name="Path 27"
                                        ...
                                        <path id="fpokmd" data-name="Path 28"
                    ...
                    <div class="widget_two">
                        ...
                        <ul>
                            ...
                            <li><a href="#"><svg width="7.514" height="11.563">
                                        <path id="poek" data-name="dfdsr" d="M261.8,353l5.369,5.053-5.369,5.053"
                                              transform="translate(-261.112 -352.271)" fill="none"
                                              stroke="rgba(43,27,154,0.55)" stroke-miterlimit="10" stroke-width="2" />
                                    </svg>
                                    service</a></li>
                    ...
                    <div class="widget_two">
                        ...
                        <ul>
                            <li><a href="portfolio.html">
                                    <svg width="7.514" height="11.563"
                                         viewBox="0 0 7.514 11.563">
                                        <path id="dst" data-name="pqe" d="M261.8,353l5.369,5.053-5.369,5.053"
                                              transform="translate(-261.112 -352.271)" fill="none"
                                              stroke="rgba(43,27,154,0.55)" stroke-miterlimit="10" stroke-width="2" />
                                    </svg>
                                    cliping path</a></li>
                            <li><a href="portfolio.html"><svg width="7.514" height="11.563"
                                                              viewBox="0 0 7.514 11.563">
                    ...
                    <div class="widget_two">
                        ...
                        <ul>
                            ...
                            <li><a href="about.html"><svg width="7.514" height="11.563" viewBox="0 0 7.514 11.563">
                                    ...
                                    reporting</a></li>
                            <li><a href="#"><svg width="7.514" height="11.563" viewBox="0 0 7.514 11.563">
                                        <path id="sdfa" data-name="Patherh" d="M261.8,353l5.369,5.053-5.369,5.053"
                                              transform="translate(-261.112 -352.271)" fill="none"
                                              stroke="rgba(43,27,154,0.55)" stroke-miterlimit="10" stroke-width="2" />
                                    </svg>
                                    documentation</a></li>
                            <li><a href="contact.html"><svg width="7.514" height="11.563"
                                                            viewBox="0 0 7.514 11.563">
