    ...
    <div class="card">
        <div class="py-4 mx-3">
            <div class="contact-form">
                <div id="success"></div>
                <div class="card-header"><h2><b>Add Commit</b></h2></div>

                <form action="{{ route('commit.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_uz" class="form-control" name="title_uz" placeholder="Foydalanuvchi haqida ma'lumot uz" value="{{ old('title_uz') }}">
                                @error('title_uz')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_ru" class="form-control" name="title_ru" placeholder="Foydalanuvchi haqida ma'lumot ru" value="{{ old('title_ru') }}">
                                @error('title_ru')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="title_en" class="form-control" name="title_en" placeholder="Foydalanuvchi haqida ma'lumot en" value="{{ old('title_en') }}">
                                @error('title_en')
