                ...
                <form action="{{ route('contact.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="title_uz"
                               placeholder="qisqacha malumot uz" value="{{ old('title_uz') }}"/>
                        @error('title_uz')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="title_ru"
                               placeholder="qisqacha malumot ru" value="{{ old('title_ru') }}"/>
                        @error('title_ru')
                    ...
                    <div class="control-group">
                        <input type="text" id="if" class="form-control p-2" name="title_en"
                               placeholder="qisqacha malumot en" value="{{ old('title_en') }}"/>
                        @error('title_en')
