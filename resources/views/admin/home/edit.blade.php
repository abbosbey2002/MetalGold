                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                <img id="first_photo_preview" src="{{ $item->first_photo ? asset('storage/' . $item->first_photo) : '' }}" style="{{ $item->first_photo ? 'display:block;' : 'display:none;' }} max-width: 100%; margin-top: 10px;" />
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="text-danger">Faylni yuklashni unutdingiz: {{ $message }}</div>
                                @enderror
                                <img id="second_photo_preview" src="{{ $item->second_photo ? asset('storage/' . $item->second_photo) : '' }}" style="{{ $item->second_photo ? 'display:block;' : 'display:none;' }} max-width: 100%; margin-top: 10px;" />
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="text-danger">Faylni yuklashni unutdingiz: {{ $message }}</div>
                                @enderror
                                <img id="third_photo_preview" src="{{ $item->third_photo ? asset('storage/' . $item->third_photo) : '' }}" style="{{ $item->third_photo ? 'display:block;' : 'display:none;' }} max-width: 100%; margin-top: 10px;" />
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="text-danger">Faylni yuklashni unutdingiz: {{ $message }}</div>
                                @enderror
                                <img id="fourth_photo_preview" src="{{ $item->fourth_photo ? asset('storage/' . $item->fourth_photo) : '' }}" style="{{ $item->fourth_photo ? 'display:block;' : 'display:none;' }} max-width: 100%; margin-top: 10px;" />
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="text-danger">Faylni yuklashni unutdingiz: {{ $message }}</div>
                                @enderror
                                <img id="fifth_photo_preview" src="{{ $item->fifth_photo ? asset('storage/' . $item->fifth_photo) : '' }}" style="{{ $item->fifth_photo ? 'display:block;' : 'display:none;' }} max-width: 100%; margin-top: 10px;" />
                            </div>
                        </div>
                    </div>
